                  ...
                  <div className="text-center py-6">
                    <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-lg p-6 border border-rose-200">
                      ...
                      {!currentUser?.verificationRequest ? (
                        ...
                        <button
                          onClick={() => navigate("/profile")}
                          className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white px-6 py-3 rounded-md transition-colors cursor-pointer w-full sm:w-auto mx-auto"
                        >
                          <User className="w-4 h-4" />
                          Go to Profile
                        </button>
